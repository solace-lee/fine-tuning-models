...
function sparseSegmentReduce(input, indices, segmentIds, isSum = false, backend) {
  ...
  const sparseSegmentSum2 = fill({ backend, attrs: { shape: outputShape, value: 0, dtype } });
  ...
  const sparseSegmentMean2 = fill({ backend, attrs: { shape: outputShape, value: 0, dtype } });
